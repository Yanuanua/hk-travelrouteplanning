...
st.markdown("<h1 style='text-align: center; color: blue; font-size: 20px;'>Method 1 \(please choose 1.0-0.9\)</h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: center; color: blue; font-size: 20px;'>Method 2 \(please select 0.0\)</h1>", unsafe_allow_html=True)
st.write('Suitable for travelers who follow popular attractions and have ample time.')
#st.title('Method 3 \(please select None\)')
st.markdown("<h1 style='text-align: center; color: blue; font-size: 20px;'>Method 3 \(please select None\)</h1>", unsafe_allow_html=True)
