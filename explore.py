...
st.write('Method 1 \(please choose 1.0-0.9\): Suitable for travelers who follow popular attractions but have limited time, are in the attractions, or have certain intentions \(the larger the number, the more dependent it is on the transition probability, and the smaller the number, the more dependent it is on the surface probability\).')
st.write('Method 2 \(please select 0.0\): Suitable for travelers who follow popular attractions and have ample time.')
st.write('Method 3 \(please select None\): Suitable for travelers who are willing to explore different attractions and have ample time.')
